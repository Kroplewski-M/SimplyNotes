...
const Auth = () =>{
    ...
    return(
            <div className="w-[300px] md:w-[500px] h-[550px] rounded-md bg-lightBrown mx-auto mt-5">
                {register ?
                (
                <div>
                    <p className="font-bold text-center text-[20px] md:text-[25px] pt-[5px]">Register</p>
                    <form action="" className="mt-5 w-[300px]  grid place-content-center items-center">
                        <label htmlFor="name" className="font-semibold mr-[5px]">Full Name:</label>
                        <input type="text" name="name" id="" className="w-[200px] rounded-md bg-gray-200 pl-[5px] mb-[10px]"/>

                        <label htmlFor="email" className="font-semibold mr-[5px]">Email:</label>
                        <input type="email" name="email" id="" className="w-[200px] rounded-md bg-gray-200 pl-[5px] mb-[10px]"/>

                        <label htmlFor="password" className="font-semibold mr-[5px]">Password:</label>
                        <input type="password" name="password" id="" className="w-[200px] rounded-md bg-gray-200 pl-[5px] mb-[10px]"/>
                    ...
                    <div className="w-[200px] mx-auto">
                        <button className="w-[100%] h-[35px] md:h-[50px] rounded-md bg-[#333333] text-gray-200 hover:bg-gray-300 hover:text-[#333333] font-semibold mt-5"
